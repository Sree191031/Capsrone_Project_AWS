...
def dataloading():
    train_data = get_reader(file_path="/content/CS60075_Course_Project__Multi_CoNER-main/Data/MULTI_Multilingual/multi_train.conll", target_vocab=get_tagset(sg.iob_tagging), 
                            encoder_model=sg.encoder_model, max_instances=sg.max_instances,
                            max_length=sg.max_length)
    #ADD CORRECT PATH IN file_path FOR EACH LANGUAGE
    dev_data_german = get_reader(file_path="/content/CS60075_Course_Project__Multi_CoNER-main/Data/DE-German/de_dev.conll", target_vocab=get_tagset(sg.iob_tagging), 
                          encoder_model=sg.encoder_model, max_instances=sg.max_instances, 
                          max_length=sg.max_length)
    dev_data_english = get_reader(file_path="/content/CS60075_Course_Project__Multi_CoNER-main/Data/EN-English/en_dev.conll", target_vocab=get_tagset(sg.iob_tagging), 
                          encoder_model=sg.encoder_model, max_instances=sg.max_instances, 
                          max_length=sg.max_length)
    dev_data_farsi = get_reader(file_path="/content/CS60075_Course_Project__Multi_CoNER-main/Data/FA-Farsi/fa_dev.conll", target_vocab=get_tagset(sg.iob_tagging), 
                          encoder_model=sg.encoder_model, max_instances=sg.max_instances, 
                          max_length=sg.max_length)
    dev_data_Russian = get_reader(file_path="/content/CS60075_Course_Project__Multi_CoNER-main/Data/RU-Russian/ru_dev.conll", target_vocab=get_tagset(sg.iob_tagging), 
                          encoder_model=sg.encoder_model, max_instances=sg.max_instances, 
                          max_length=sg.max_length)
    dev_data_Hindi = get_reader(file_path="/content/CS60075_Course_Project__Multi_CoNER-main/Data/HI-Hindi/hi_dev.conll", target_vocab=get_tagset(sg.iob_tagging), 
                          encoder_model=sg.encoder_model, max_instances=sg.max_instances, 
                          max_length=sg.max_length)
    dev_data_Chinese = get_reader(file_path="/content/CS60075_Course_Project__Multi_CoNER-main/Data/ZH-Chinese/zh_dev.conll", target_vocab=get_tagset(sg.iob_tagging), 
                          encoder_model=sg.encoder_model, max_instances=sg.max_instances, 
                          max_length=sg.max_length)
    dev_data_Korean = get_reader(file_path="/content/CS60075_Course_Project__Multi_CoNER-main/Data/KO-Korean/ko_dev.conll", target_vocab=get_tagset(sg.iob_tagging), 
                          encoder_model=sg.encoder_model, max_instances=sg.max_instances, 
                          max_length=sg.max_length)
    dev_data_Bangla = get_reader(file_path="/content/CS60075_Course_Project__Multi_CoNER-main/Data/BN-Bangla/bn_dev.conll", target_vocab=get_tagset(sg.iob_tagging), 
                          encoder_model=sg.encoder_model, max_instances=sg.max_instances, 
                          max_length=sg.max_length)
    dev_data_Spanish = get_reader(file_path="/content/CS60075_Course_Project__Multi_CoNER-main/Data/ES-Spanish/es_dev.conll", target_vocab=get_tagset(sg.iob_tagging), 
                          encoder_model=sg.encoder_model, max_instances=sg.max_instances, 
                          max_length=sg.max_length)
    dev_data_Dutch = get_reader(file_path="/content/CS60075_Course_Project__Multi_CoNER-main/Data/NL-Dutch/nl_dev.conll", target_vocab=get_tagset(sg.iob_tagging), 
                          encoder_model=sg.encoder_model, max_instances=sg.max_instances, 
                          max_length=sg.max_length)
    dev_data_Turkish = get_reader(file_path="/content/CS60075_Course_Project__Multi_CoNER-main/Data/TR-Turkish/tr_dev.conll", target_vocab=get_tagset(sg.iob_tagging), 
                          encoder_model=sg.encoder_model, max_instances=sg.max_instances, 
                          max_length=sg.max_length)

    return train_data, dev_data_german,dev_data_english,dev_data_farsi,dev_data_Russian,dev_data_Hindi,dev_data_Chinese,dev_data_Korean,dev_data_Bangla,dev_data_Spanish,dev_data_Dutch,dev_data_Turkish

train_data, dev_data_german,dev_data_english,dev_data_farsi,dev_data_Russian,dev_data_Hindi,dev_data_Chinese,dev_data_Korean,dev_data_Bangla,dev_data_Spanish,dev_data_Dutch,dev_data_Turkish = dataloading()
...
model = NERModel(tag_to_id = train_data.get_target_vocab(), dropout_rate = sg.dropout, 
                 batch_size = sg.batch_size, hidden_size = sg.hidden_size, 
                 stage = sg.stage, lr = sg.lr, encoder_model = sg.encoder_model, num_gpus = sg.gpus)
...
def evaluate(Language,dev_data):
    print()
    print("--------------------- Evaluation on ",Language,"-------------------------")
    print()
    
    # Loop for evaluation on validation set
    
    validation_dataloader = val_dataloader(dev_data)
...
evaluate("German",dev_data_german)
evaluate("English",dev_data_english)
evaluate("Farsi",dev_data_farsi)
evaluate("Russian",dev_data_Russian)
evaluate("Hindi",dev_data_Hindi)
evaluate("Chinese",dev_data_Chinese)
evaluate("Korean",dev_data_Korean)
evaluate("Bangla",dev_data_Bangla)
evaluate("Spanish",dev_data_Spanish)
evaluate("Dutch",dev_data_Dutch)
evaluate("Turkish",dev_data_Turkish)