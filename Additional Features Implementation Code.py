...
class Args():
    ...
    def __init__(self):
        ...
        self.train = '/content/CS60075_Course_Project__Multi_CoNER-main/EN-English/en_train.conll'
        self.test = '/content/CS60075_Course_Project__Multi_CoNER-main/EN-English/en_dev.conll'
        self.dev = '/content/CS60075_Course_Project__Multi_CoNER-main/EN-English/en_dev.conll'
       
        self.train_features = '/content/CS60075_Course_Project__Multi_CoNER-main/Data/en_train_features.csv'
        self.test_features = '/content/CS60075_Course_Project__Multi_CoNER-main/Data/en_dev_features.csv'
        self.dev_features = '/content/CS60075_Course_Project__Multi_CoNER-main/Data/en_dev_features.csv'
